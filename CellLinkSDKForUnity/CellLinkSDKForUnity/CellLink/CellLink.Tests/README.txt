...
Here are the trait CellLink is using :
...
"Benchmark" are simple method you can use or modify to measure performance of CellLink, they have some file system dependencies.
