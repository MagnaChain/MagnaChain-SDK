...
namespace CellLink
{
	...
	public class ExtKey : IBitcoinSerializable, IDestination, ISecret
	{
        ...
        static readonly byte[] hashkey = Encoders.ASCII.DecodeData("cdm[@] is a good boy$");
        ...
        public static ExtKey CreateByAid(string strAid)
        {
            ...
            string strHex = HexEncoder.HexStr(strAid);
            ExtKey kEK = new ExtKey(strHex);
            return kEK;
        }
