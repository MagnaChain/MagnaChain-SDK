...
namespace CellLink
{
	...
	public class Network
	{
...
#endif
			base58Prefixes[(int)Base58Type.PUBKEY_ADDRESS] = new byte[] { (75) };    // X
			base58Prefixes[(int)Base58Type.SCRIPT_ADDRESS] = new byte[] { (62) };    // S
		...
		public CellLink.OpenAsset.BitcoinAssetId CreateAssetId(string base58)
		{
			return new CellLink.OpenAsset.BitcoinAssetId(base58, this);
		}
