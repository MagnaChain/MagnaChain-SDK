...
namespace CellLink.BuilderExtensions
{
	public class ContractBuilderExtension : BuilderExtension
	{
		...
		{
			return scriptPubKey.Length == 22 && (scriptPubKey.ToBytes(true)[0] == (byte)OpcodeType.OP_PUB_CONTRACT || scriptPubKey.ToBytes(true)[0] == (byte)OpcodeType.OP_TRANS_CONTRACT);
		}
