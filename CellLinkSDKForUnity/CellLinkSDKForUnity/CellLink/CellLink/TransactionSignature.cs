...
namespace CellLink
{
	...
	{
		static readonly TransactionSignature _Empty = new TransactionSignature(new ECDSASignature(CellLink.BouncyCastle.Math.BigInteger.ValueOf(0), CellLink.BouncyCastle.Math.BigInteger.ValueOf(0)), SigHash.All);
