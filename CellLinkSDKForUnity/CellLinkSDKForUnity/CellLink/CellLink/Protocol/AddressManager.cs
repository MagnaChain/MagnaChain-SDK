...
using CellLink.Protocol.Behaviors;
using System;
...
namespace CellLink.Protocol
{
	...
	public class AddressManager : IBitcoinSerializable
	{
		...
		{
			if(!value)
				throw new InvalidOperationException("Bug in AddressManager, should never happen, contact CellLink developpers if you see this exception");
		}
