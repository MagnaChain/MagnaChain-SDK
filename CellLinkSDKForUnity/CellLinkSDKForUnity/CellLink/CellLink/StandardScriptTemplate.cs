...
namespace CellLink
{
    ...
    public class ContractTemplate : ScriptTemplate
    {
        private static readonly ContractTemplate _Instance = new ContractTemplate();
        public static ContractTemplate Instance
        {
            get
            {
                return _Instance;
        ...
        //{
        //    return new Script(
        //            OpcodeType.OP_PUB_CONTRACT,// OpcodeType.OP_TRANS_CONTRACT,
        //            Op.GetPushOp(pubkeyHash.ToBytes())
        //        );
        //}
        //public Script GenerateScriptSig(TransactionSignature signature, PubKey publicKey)
        ...
        protected override bool FastCheckScriptPubKey(Script scriptPubKey, out bool needMoreCheck)
        {
            ...
            return bytes.Length == 22 &&
                   (bytes[0] == (byte)OpcodeType.OP_PUB_CONTRACT || bytes[0] == (byte)OpcodeType.OP_TRANS_CONTRACT); // 同一个    
        }
        ...
        //    if (!FastCheckScriptPubKey(scriptPubKey, out needMoreCheck))
        //        return null;
        //    return new KeyId(scriptPubKey.ToBytes(true).SafeSubarray(1, 22));
        //}
        ...
        public override TxOutType Type
        {
            get
            {
                return TxOutType.TX_PUBCONTRACT;
            }
        }
