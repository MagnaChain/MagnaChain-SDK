...
public class RPCConsole : EditorWindow
{
    ...
    private IxCellLinkBridge m_kCB;
    ...
    private void InitCommand()
    {
        ...
        listArgsInfo.Add("\"nrequired\", \"keys\"");
        ...
        listArgsInfo.Add("\"inputs\", \"outputs\", \"locktime\", \"replaceable\"");
        ...
        listArgsInfo.Add("\"nrequired\", \"keys\", \"account\"");
        ...
        listArgsInfo.Add("\"newsize\"");
        listCmd.Add("listaccounts");
        listArgsInfo.Add("\"minconf\", \"include_watchonly\"");
        listCmd.Add("listaddressgroupings");
        listArgsInfo.Add("");
        listCmd.Add("listlockunspent");
        listArgsInfo.Add("");
        listCmd.Add("listreceivedbyaccount");
        listArgsInfo.Add("\"minconf\", \"include_empty\", \"include_watchonly\"");
        listCmd.Add("listreceivedbyaddress");
        listArgsInfo.Add("\"minconf\", \"include_empty\", \"include_watchonly\"");
        listCmd.Add("listsinceblock");
        listArgsInfo.Add("\"blockhash\", \"target_confirmations\", \"include_watchonly\", \"include_removed\"");
        listCmd.Add("listtransactions");
        listArgsInfo.Add("\"account\", \"count\", \"skip\", \"include_watchonly\"");
        listCmd.Add("listunspent");
        listArgsInfo.Add("\"minconf\", \"maxconf\", \"addresses\", \"include_unsafe\", \"query_options\"");
        listCmd.Add("listwallets");
        listArgsInfo.Add("");
        listCmd.Add("lockunspent");
        listArgsInfo.Add("\"unlock\", \"transactions\"");
        listCmd.Add("move");
        listArgsInfo.Add("\"fromaccount\", \"toaccount\", \"amount\", \"minconf\", \"comment\"");
        listCmd.Add("sendfrom");
        listArgsInfo.Add("\"fromaccount\", \"toaddress\", \"amount\", \"minconf\", \"comment\", \"comment_to\"");
        listCmd.Add("sendmany");
        listArgsInfo.Add("\"fromaccount\", \"amounts\", \"minconf\", \"comment\", \"subtractfeefrom\", \"replaceable\", \"conf_target\", \"estimate_mode\"");
        listCmd.Add("sendtoaddress");
        listArgsInfo.Add("\"address\", \"amount\", \"comment\", \"comment_to\", \"subtractfeefromamount\", \"replaceable\", \"conf_target\", \"estimate_mode\"");
        listCmd.Add("startbranch");
        listArgsInfo.Add("");
        listCmd.Add("generateforbranch");
        listArgsInfo.Add("\"address\"");
        listCmd.Add("getbranchinfo");
        listArgsInfo.Add("\"address\"");
        listCmd.Add("switchbranch");
        listArgsInfo.Add("\"address\"");
        listCmd.Add("publish");
        listArgsInfo.Add("\"filename\"");
        ...
        listCmd.Add("call");
        listArgsInfo.Add("\"contract address\"");
        listCmd.Add("sendcall");
        listArgsInfo.Add("\"contract address\"");
        ...
        listArgsInfo.Add("\"nblocks\", \"maxtries\"");
        ...
        listArgsInfo.Add("");
        listCmd.Add("setban");
        listArgsInfo.Add("\"subnet\", \"command\", \"bantime\", \"absolute\"");
    ...
    private static void OpenRPCConsole()
    {
        ...
        ms_kSig = GetWindow<RPCConsole>(false, "CellLink", true);
    ...
    {
        ms_strTemplateLuaPrefix = Application.dataPath + "/CellLink/Contract/Src/";
        ...
        ms_kSig.m_texIcon = AssetDatabase.LoadAssetAtPath("Assets/CellLink/Editor/res/celllink_icon.png", typeof(Texture)) as Texture;                
    }
    ...
    private void ResolveExeCommand()
    {
        ...
        char[] arrSpt = new char[1];
        arrSpt[0] = ' ';
        string[] arrSeg = m_strRawExeRpcCommand.Split(arrSpt);
    ...
    private void DrawConsoleUI(float fYOffset)
    {
        ...
        if (GUILayout.Button("Execute", arrLO))
        {
            if (m_bCBInited == false)
            {
                if (EditorUtility.DisplayDialog("Erorr", "CellLink has not initialized", "OK"))
                {
                    return;
                }
            }
        ...
        if (GUILayout.Button("Call Contract Function", arrLO))
        {
            ...
            if ( !string.IsNullOrEmpty(m_strCallArgs))
            {
                char[] arrSpt = new char[1];
                arrSpt[0] = ' ';
                arrArg = m_strCallArgs.Split(arrSpt);
            }
    ...
    private void DrawSettingsUI(float fYOffset)
    {
        ...
        if (GUILayout.Button("Import Master Key", arrLO))
        {
            if ( m_kCB == null )
            {
                if (EditorUtility.DisplayDialog("Prompt", "CellLink has not initialized.", "OK"))
                {
                    return;
                }
            }
