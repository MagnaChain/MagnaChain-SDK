...
namespace CellLinkEx
{
    public class IxCellLinkBridge
    {
        ...
        //public static IxCellLinkBridge ms_kSig;
        ...
        private float ComputeFee(List<Coin> listCoins)
        {
            ...
            return UnityEngine.Random.Range(0.0001f, 0.00001f);
        }
        ...
        public bool TransferRaw(string strFromPriKey, string strToCelAddress, float fMoney, out string strTxid, float fFee = -1.0f, string strChangeCelAddress = null)
        {
            strTxid = null;
            ...
            string strQueryBalance = "getaddresscoins " + strFromBTAddress;
        ...
        public bool TransferMCLToMCLAddress(string strFromMCLAddress, string strToMCLAddress, float fMoney, out string strTxid, float fFee = -1.0f, string strChangeMCLAddress = null)
        {
            strTxid = null;
            ...
            return TransferMCLToCelAddress(strFromMCLAddress, strToBTAddress, fMoney, out strTxid, fFee, strChangeBTAddress);
        }

        public bool TransferMCLToCelAddress(string strFromMCLAddress, string strToCelAddress, float fMoney, out string strTxid, float fFee = -1.0f, string strChangeCelAddress = null)
        {
            strTxid = null;
            ...
            return TransferRaw(kFrmoKey.PrivateKey.GetWif(m_kCLNet).ToWif(), strToCelAddress, fMoney, out strTxid, fFee, strChangeCelAddress);
        }     
        ...
        {            
            ...
            ON_COMMAND_DONE fnPublishDone = delegate (RPCResponse kRsp)
            {
                ...
                string strContractAddress = tx.ContractAddress.GetAddress(m_kCLNet).ToWif();
        ...
        public bool PublishContract(out string strContractAddress, string strContractContent, Key kCostPriKey, float fCostAmount, Key kSenderPriKey, string strChargeCelAddress = null)
        {
            ...
            Transaction tx = Transaction.Parse((string)kTX);
            strContractAddress = tx.ContractAddress.GetAddress(m_kCLNet).ToWif();
