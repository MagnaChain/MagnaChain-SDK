...
public class TestCellLink : MonoBehaviour
{
    ...
    //private CellLink.Network m_CLNet = CellLink.Network.Main;

    private IxCellLinkBridge m_kCLB;

    private string m_strMasterKeyName = "TestCellLink_Cat";
    ...
    void Awake()
    {
        ...
        //Debug.Log("0: " + kEK0.ToString(CellLink.Network.Main));

        //ExtKey kEK1 = ExtKey.CreateByAid("chemo is good ");
        //Debug.Log("1: " + kEK1.ToString(CellLink.Network.Main));

        //ExtKey kEK2 = ExtKey.CreateByAid("chemoi is good");
        //Debug.Log("2: " + kEK2.ToString(CellLink.Network.Main));

        //ExtKey kEK3 = ExtKey.CreateByAid("chemo is good");
        //Debug.Log("3: " + kEK3.ToString(CellLink.Network.Main));

        //ExtKey kEK4 = ExtKey.CreateByAid("chemo is good, ok go!");
        //Debug.Log("4: " + kEK4.ToString(CellLink.Network.Main));
        ...
        //Debug.Log("5: " + kEK5.ToString(CellLink.Network.Main));
        ...
        //Debug.Log("6: " + kEK6.ToString(CellLink.Network.Main));
        ...
        //Debug.Log("7: " + kEK7.ToString(CellLink.Network.Main));

        //ExtKey kEK8 = ExtKey.CreateByAid("chemo is good");
        //Debug.Log("8: " + kEK8.ToString(CellLink.Network.Main));
        ...
        //Debug.Log("9: " + kEK9.ToString(CellLink.Network.Main));
    }
    ...
    {
        string strPrefix = "TestCellLink_MN_";
    ...
    public void Transfer(string strDestBTAddress, string strChangeBTAddress, float fMoney)
    {
        ...
        if ( m_kCLB.TransferRaw(strPriKey, strDestBTAddress, fMoney, out strTxid, -1.0f, strChangeBTAddress) == false )
        {
